...
fpu_add  fpu_add_inst (
    .clock(clock),
    .fpu_add_start(p3_is_fpu && (fpu_op==3'h0 || fpu_op==3'h1)), // add/sub
    .fpu_add_sub(fpu_op==3'h1),
    .fpu_a(fpu_in_a),
    .fpu_b(fpu_in_b),
...
fpu_mult  fpu_mult_inst (
    .clock(clock),
    .fpu_mult_start(p3_is_fpu && fpu_op==3'h2),
    .fpu_a(fpu_in_a),
    .fpu_b(fpu_in_b),
    .fpu_dest(fpu_in_dest),
...
fpu_div  fpu_div_inst (
    .clock(clock),
    .fpu_div_start(p3_is_fpu && fpu_op==3'h3),
    .fpu_a(fpu_in_a),
    .fpu_b(fpu_in_b),
    .fpu_dest(fpu_in_dest),
    .div_valid(div_valid),
